...
class Startsc3D(QWidget):
    ...
    @magicgui(call_button= 'a', a={'value': 'test'})
    def get_parameters(self, a):
        print(a)

    @magicgui(call_button= 'b', b={'value': 'adaesf'})
    ...
    def __init__(self, napari_viewer):
        ...
        a = QWidget()
        a.setLayout(QHBoxLayout())
        a.layout().addWidget(self.get_parameters.native)
        a.layout().addWidget(self.load_file.native)
